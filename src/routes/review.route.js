...
import { alluserratingofcreatorreview, alluserratingofreview, autodeletereplyreport, autodeletereport, deletereplycomment, deleteusercomment, editreplycomment, editusercomment, getallcommentofreview, getallreplycomment, getcreatorreview, getnotificationuser, getonlyreply, latestreview, likereplycomment, likeusercomment, removedownvotes, removelikereview, removereplylike, removeupvotes, removeuserlikecomment, replycomment, replycommenttoreply, reportreplycomment, reportusercomment, showcommentofparticularreview, showcurrentcoursereview, showcurrentreplycomment, usercomment, userdownvotes, userlike, userupvotes, userwritereview } from "../controllers/review.controller.js";
const router = Router()
...
router.route("/autodeletereportcomment").get(autodeletereport)
...
router.route("/autoreportreply").get(autodeletereplyreport)
